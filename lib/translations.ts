...
const en = {
  ...
  settings: {
    ...
    smsBody:            'Get gas price alerts, fill-up reminders, and tips by text. Message & data rates may apply. Reply STOP at any time to opt out.',
    smsAddPhone:        'Add a phone number above to enable SMS.',
    smsConsent:         '✓ By checking this box you consent to receive recurring automated text messages from Gas Capacity LLC at the number provided. Consent is not a condition of purchase.',
    saved:              '✓ Saved!',
    saving:             'Saving…',
...
const es: typeof en = {
  ...
  settings: {
    ...
    smsBody:            'Recibe alertas de precios de gasolina, recordatorios de recarga y consejos por mensaje. Pueden aplicarse tarifas de mensajes y datos. Responde STOP en cualquier momento para cancelar.',
    smsAddPhone:        'Agrega un número de teléfono arriba para activar el SMS.',
    smsConsent:         '✓ Al marcar esta casilla aceptas recibir mensajes de texto automatizados y recurrentes de Gas Capacity LLC al número proporcionado. El consentimiento no es condición de compra.',
    saved:              '✓ ¡Guardado!',
    saving:             'Guardando…',
