...
const en = {
  ...
  pricing: {
    ...
    getawayDisclosure: 'Complimentary resort stay (no timeshare) — you cover only the taxes & fees, which vary by destination. Must be 21+, live 100+ miles from your destination, and book 30+ days ahead. Full terms at RedeemVacations.com.',
    ...
    getawayPickerNote:          'You pay only the nightly taxes & fees shown (varies by destination). Must be 21+ and live 100+ miles from your chosen destination.',
...
const es: typeof en = {
  ...
  pricing: {
    ...
    getawayDisclosure: 'Estancia de cortesía en resort (sin presentación de tiempo compartido) — solo cubres los impuestos y tarifas, que varían según el destino. Debes ser mayor de 21, vivir a más de 160 km del destino y reservar con 30+ días de anticipación. Términos completos en RedeemVacations.com.',
    ...
    getawayPickerNote:          'Solo pagas los impuestos y tarifas nocturnos indicados (varían según el destino). Debes ser mayor de 21 y vivir a más de 160 km del destino elegido.',
