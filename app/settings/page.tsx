            ...
            <div>
              ...
              {showQR && (
                <div className="mt-3 flex flex-col items-center gap-3 bg-slate-50 border border-slate-200 rounded-2xl p-4">
                  ...
                  {/* Branded QR code — brand-green with the GasCap icon centered, via /api/qr */}
                  <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-100">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={`/api/qr?size=400&data=${encodeURIComponent(referral.referralUrl)}`}
                  ...
                  <div className="flex gap-2 w-full max-w-xs">
                    {/* Download */}
                    <a
                      href={`/api/qr?size=900&data=${encodeURIComponent(referral.referralUrl)}`}
