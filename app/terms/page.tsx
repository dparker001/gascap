      ...
      <div className="max-w-2xl mx-auto px-5 py-10 pb-20">
        ...
        <div className="space-y-8 text-slate-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2"><strong>Credit Timing &amp; Tier Updates.</strong> Referral credits and tier status updates are processed within 24 hours of the referred user&apos;s first qualifying payment. Tier thresholds, once crossed, are permanent — they are not revoked if referred users subsequently cancel.</p>
