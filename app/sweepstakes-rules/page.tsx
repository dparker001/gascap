...
export const metadata: Metadata = {
  ...
  description: 'Official rules for the GasCap™ Monthly $50 Gas Card Giveaway.',
};

const PRIZE_VALUE = '$50';
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-[#005F4A] pt-12 pb-8 px-5">
        <div className="max-w-2xl mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-xs mt-0.5">GasCap™ Monthly $50 Gas Card Giveaway</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm divide-y divide-slate-50">
          ...
          <section className="p-5 space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              The GasCap™ Monthly $50 Gas Card Giveaway (&ldquo;Sweepstakes&rdquo;) is sponsored by {SPONSOR}
          ...
          <section className="p-5 space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              <strong>Winner Frequency Restriction:</strong> A person who won a prize in the
              immediately preceding Entry Month, or who has already won a prize during the same
              calendar quarter as the current Entry Month, is not eligible to win again in the
              current Entry Month. If a selected winner is ineligible under this restriction, an
              additional drawing will be conducted from the remaining eligible entries until an
              eligible winner is selected.
            </p>
            <p className="text-sm text-slate-600 leading-relaxed">
              ...
              of the current Entry Month are exempt from the Winner Frequency Restriction set forth
              above. Such entrants are eligible to win in any Entry Month, including consecutive
              months. Tier status is determined by cumulative paying referral count as of the
              first day of the Entry Month.
            </p>
          </section>
          ...
          <section className="p-5 space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Each Sweepstakes period covers one calendar month (the &ldquo;Entry Month&rdquo;),
              beginning at 12:00:00 AM Eastern Time on the first day of the month and ending at
              11:59:59 PM Eastern Time on the last day of the month. A new drawing is held at the
              end of each Entry Month.
            </p>
          </section>
          ...
          <section className="p-5 space-y-2">
            ...
            <div className="space-y-3 text-sm text-slate-600 leading-relaxed">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm text-slate-600">
                <li><strong>Standard (0–4 cumulative paying referrals):</strong> one (1) entry per active day; maximum approximately 31 base entries per Entry Month.</li>
                <li><strong>Supporter tier (5–14 cumulative paying referrals):</strong> two (2) entries per active day; maximum approximately 62 base entries per Entry Month.</li>
                <li><strong>Ambassador tier (15–29 cumulative paying referrals):</strong> three (3) entries per active day; maximum approximately 93 base entries per Entry Month.</li>
                <li><strong>Elite Ambassador tier (30 or more cumulative paying referrals):</strong> five (5) entries per active day; maximum approximately 155 base entries per Entry Month.</li>
              </ul>
              <p>
              ...
              <p>
                ...
                as of the last day of the Entry Month: 7–29 consecutive days = 3 bonus entries;
                30–89 consecutive days = 8 bonus entries; 90–179 consecutive days = 40 bonus
                entries; 180–364 consecutive days = 70 bonus entries; 365 or more consecutive days
                = 120 bonus entries. Streak bonus entries require at least one (1) base active-day
          ...
          <section className="p-5 space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              On or about the last day of each Entry Month, the Sponsor will conduct
        ...
        <p className="text-[10px] text-slate-400 text-center leading-relaxed pb-4">
          ...
          Official Rules for the GasCap™ Monthly $50 Gas Card Giveaway.{' '}
