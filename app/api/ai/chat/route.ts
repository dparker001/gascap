...
- Streak Rewards: milestones at 30/90/180/365 days — Monthly members earn free Pro months; Lifetime members earn bonus giveaway entries instead. Every milestone (any plan) also earns a one-time Marketing Boost voucher, sent automatically by email: $25 Dining Voucher (30 days), $50 Dining Voucher (90 days), $100 Hotel Savings Card (180 days), $300 Hotel Savings Card (365 days)
- Monthly gas card giveaway ($50, drawn at month end): Pro users earn daily entries based on usage + ambassador tier; bonus entries for streaks, plan level, referrals
- Ambassador Program tiers (cumulative paying referrals) also earn one-time Marketing Boost vouchers, sent automatically the moment a referrer first reaches each tier: Supporter (5+ referrals) → $50 Dining Voucher; Ambassador (15+ referrals) → $100 Hotel Savings Card; Elite (30+ referrals) → $500 Hotel Savings Card
